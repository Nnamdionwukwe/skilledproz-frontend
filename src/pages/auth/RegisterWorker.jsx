...
export default function RegisterWorker() {
  ...
  const validate = () => {
    ...
    if (!form.category) e.category = "Select a trade";
    ...
    <AuthLayout>
      <div className={`${s.container} ${s.containerWide}`}>
        ...
        <div className={s.header}>
          <span className={s.eyebrow}>Worker account</span>
        ...
        <form className={s.form} onSubmit={handleSubmit} noValidate>
          ...
          <div className={s.sectionLabel}>Trade Information</div>
          <div className={`${s.field} ${errors.category ? s.fieldError : ""}`}>
            <label className={s.label}>Your trade / skill</label>
            <div className={s.inputWrap}>
              <span className={s.iconLeft}>
                <Wrench size={14} />
              </span>
          ...
          <div className={s.row}>
            ...
            >
              <label className={s.label}>Hourly rate (₦)</label>
              <div className={s.inputWrap}>
                <span className={s.iconLeft}>
                  <DollarSign size={14} />
                </span>
              ...
              {errors.hourlyRate && (
                <span className={s.errMsg}>{errors.hourlyRate}</span>
              )}
            </div>
            <div className={s.field}>
              <label className={s.label}>Service radius (km)</label>
              <div className={s.inputWrap}>
                <input
                  className={s.input}
                  type="number"
